...
const static struct{
	...
	{"v42l.device", Option::StringOpt, ":device=", "", false, "video.source", "v4l2"},
	{"v42l.codec", Option::StringOpt, ":codec=", "", false, "video.source", "v4l2"},
	{"v42l.size", Option::StringOpt, ":size=", "", false, "video.source", "v4l2"},
	{"v42l.tpf", Option::StringOpt, ":tpf=", "", false, "video.source", "v4l2"},
	{"v42l.force_rgb", Option::BoolOpt, ":RGB", "t", true, "video.source", "v4l2"},
